...
import info.rajeshg.iot.sensors.R;
import info.rajeshg.iot.sensors.ble.BleRecorder;
...
public class SensorsRecorder implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final int DEFAULT_PORT = 20160;
    public static final int DEFAULT_PROTOCOL = PROTOCOL_TCP;
    public static final String DEFAULT_HOST = "iot.rajeshg.info";
    public static final boolean DEFAULT_NETWORK_SAVE = true;
    public static final boolean DEFAULT_FILE_SAVE = false;
